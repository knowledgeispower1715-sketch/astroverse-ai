...
// Custom SVG components for brand icons to avoid version dependencies
const TwitterIcon = () => (
...
export function Footer() {
  return (
    <footer style={{ background: "var(--bg-secondary)" }}>
      {/* Gradient top border */}
      <div className="h-px w-full" style={{ background: "var(--gradient-cosmic)" }} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold text-gradient-gold" style={{ fontFamily: "var(--font-outfit)" }}>
                AstroVerse AI
              </span>
            </Link>
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  style={{ background: "rgba(212, 175, 55, 0.1)", color: "var(--text-secondary)" }}
                >
                  <Icon />
                </a>
              ))}
        ...
        <Separator className="my-8" style={{ background: "rgba(212, 175, 55, 0.1)" }} />
